...
/**
 * 剑指 Offer II 031. 最近最少使用缓存 运用所掌握的数据结构，设计和实现一个 LRU (Least Recently Used，最近最少使用) 缓存机制 。
 *
 * <p>实现 LRUCache 类：
 *
 * <p>LRUCache(int capacity) 以正整数作为容量 capacity 初始化 LRU 缓存 int get(int key) 如果关键字 key
 ...
 * <p>提示：
 *
 * <p>1 <= capacity <= 3000 0 <= key <= 10000 0 <= value <= 105 最多调用 2 * 105 次 get 和 put
 */
